...
// questMarkersRetireLabel removes a marker by its label alone, any zone — the
// tick-time retirement for nudge flags: once the item is in hand the reminder
// is done, wherever it was pointing, without waiting for the visited-and-left
// lifecycle to notice.
