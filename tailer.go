...
func notifyLogFile(path string) {
	...
	if changed {
		ClearPosition()
		// The old toon left the world: pause their Buffs (Self)/Disciplines
		// timers (resumed on their next login) and clear the rest. The new
