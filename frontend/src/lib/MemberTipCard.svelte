<script>
  // The member hover card — the guild-chat identity bracket's counterpart to
  // ItemTipCard, and deliberately built to look like it: same box, same gold
  ...
  // The FULL display name here: the bracket in the chat overlay is the one
  // that truncates, and this card is where the rest of it belongs.
