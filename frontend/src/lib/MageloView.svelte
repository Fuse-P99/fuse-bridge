        ...
        <div class="mg-lib-share">
          ...
          {:else}
            ...
            <div class="mg-lib-sharenote">
              ...
              {:else}
                This publishes <strong>Current</strong> as a live view — it
                follows your gear from here on, so you only share it once.
              {/if}
            </div>
          {/if}
        </div>
