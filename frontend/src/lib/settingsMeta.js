...
export const FWD_OPTIONS = [
  ...
  // they belong where a member looks to see what their client sends.
  {
    key: "melee_info",
    label: "Melee Info",
    tip: "Shares the damage your client parses from your log — melee, spells, procs and damage shield — with the raid DPS meter and the parse filed on a kill. Off, your name won't appear on anyone's board.",
  },
  {
    key: "spell_info",
    label: "Spell Info",
    tip: "Lets the DPS & Threat overlay account for your nukes and debuffs, locally and in what your client reports. Off, a caster's hate reads as zero; damage is unaffected.",
  },
  {
    key: "pet_info",
    label: "Pet Info",
    tip: "Sends your pet commands to the server to associate you with your pet for DPS tracking, so its damage files as <You> + Pet.",
  },
  {
...
export const SETTINGS_SECTIONS = [
  { id: "basic", title: "Basic Settings", items: BASIC_OPTIONS },
  {
    id: "automations",
    title: "Automations",
    items: AUTOMATION_OPTIONS,
    linked: true,
  },
  {
    id: "forwarded",
    title: "Forwarded Messages",
    items: [...FWD_OPTIONS, SHARE_MAGELOS],
  },
...
export const MAP_OPTIONS = [
  {
    key: "trail",
    label: "Show Trail",
    tip: "Map tab: draw the path your character has walked this session.",
  },
  {
    key: "focus_level",
    label: "Focus Current Level",
    tip: "Map tab: fade map lines that belong to other floors/levels of the zone.",
  },
  {
    key: "grid_always",
    label: "Coordinate grid (always)",
    tip: "Map tab: the loc-space grid switched on permanently rather than just for this session.",
  },
  {
    key: "autohide",
    label: "Auto-hide overlay",
    tip: "Map overlay: slide up to just the title bar after a minute with no /loc, and back down on the next one.",
  },
  {
    key: "aot",
    label: "Overlay always on top",
    tip: "Map overlay: kept above the game window.",
  },
  {
    key: "stay_unlocked",
    label: "Stay unlocked",
    tip: "Map overlay: keeps the map interactive (pan/zoom/search) when Lock Overlays is pressed on the Timers tab.",
  },
  {
    key: "overlay_open",
    label: "Map overlay open",
    tip: "The map overlay was open (or set to reopen at launch) when the snapshot was taken.",
  },
];
