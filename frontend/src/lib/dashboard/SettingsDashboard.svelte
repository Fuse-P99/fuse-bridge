<script>
  ...
  const OVERLAY_TIPS = {
    ...
    engages: "Include raid-mob engage lines in the Guild Chat overlay.",
    newesttop:
      "Guild Chat: messages reversed — newest line at the top instead of the bottom.",
    msgbold: "Guild Chat: message text in bold.",
    msgfont_set: "Guild Chat: a custom font is set for message text.",
    msgcolor_set: "Guild Chat: a custom color is set for message text.",
    msgsize_set: "Guild Chat: a custom size is set for the chat lines.",
    stayunlocked:
      "Keep the Guild Chat overlay interactive under Lock Overlays (the map's rule).",
