<script>
  ...
  let copied = ""; // say-text most recently copied, for the confirmation
  let copiedTimer;
                    ...
                    <div class="q-check" class:q-ticked={done.has(`${q.id}:${i}`)}>
                      ...
                      <div class="q-checktext">
                        <div class="q-stephead">
                          <span class="q-stepkind">{KIND_LABEL[s.kind] || s.kind}</span>
                          <span class="q-stepwhat">{stepHead(s)}</span>
                        </div>

                        {#if s.mobs && s.mobs.length}
                          <div class="q-fact">
                            <span class="q-fkey">{MOB_LABEL[s.kind] || "NPC"}</span>
                        ...
                        {#if s.say}
                          ...
                          <div class="q-fact">
                            ...
                            <button
                              class="q-say"
                              title="Click to copy"
                              on:click|stopPropagation={() => copySay(s.say)}
                              >“{s.say}”{#if copied === s.say}<span class="q-copied"
                                  >copied</span
                                >{/if}</button
                            >
                          </div>
