<script>
  ...
  // Guard members too: the server can send a group with members:null (no one of
  // that class), and .length on null throws mid-render, killing the whole UI.
  function groupFor(ab) {
