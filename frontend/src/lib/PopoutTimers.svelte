<script>
  ...
  // Bar height is DRIVEN by the configured font size — the text plus a little
  // breathing room above and below — never by the window: a bar in a tall
  // window must not inflate to fill it. (Bars used to be flex-grow with this
  // as a max-height cap; that stretched in some layouts, which is how a fresh
