<script>
  ...
  // "shadow knight" → "Shadow Knight". Unknown names (non-guild raiders the
  // roster has never seen) come through as "unknown", and the folded tail of
  // the class list as "remaining" — both capitalize the same way.
