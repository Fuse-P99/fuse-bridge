<script>
  ...
  import { stepLine } from "../lib/questSteps.js";
  ...
  function pieceTitle(holders, m) {
    const hs = (holders || {})[m.item_id] || [];
    if (!hs.length) return "No other characters hold this piece";
    return (
      "Held by: " +
      hs
        .map(
                    ...
                    {#if questsOpen[a.quest.id]}
                      <div class="q-body" transition:slide|local={{ duration: 120 }}>
                          ...
                          <div class="q-step" class:done={st && st.done}>
                            ...
                            <span class="q-steptext">
                              {#each stepLine(s) as tk}
                                ...
                                {:else if tk.t === "item"}<span class="q-item"
                                    >{tk.name}</span
                                  >
                                ...
                                {:else if tk.t === "mob"}<span class="q-mob"
                                    >{tk.names.join(" / ")}</span
                                  >
                                {:else if tk.t === "say"}<span class="q-say"
                                    >“{s.say}”</span
                                  >
                        ...
                        <!-- Medallion grid, inside the quest's own card like
                             ...
                             Hovering a piece names which of YOUR characters
                             hold it (id-aware; the nine share one name). -->
                          ...
                          <div class="q-medgrid">
                            {#each medallionRows(questsData.medallions) as row (row.rune)}
                              ...
                              <!-- The completed medallion in the bags turns
                                   ...
                                   otherwise it says where the pieces go. -->
                ...
                {#if questsData.completions.length}
                  ...
                  {#each questsData.completions as c (c.quest_id)}
                    <div class="q-comp">
                      ...
                      <span class="q-compitem">{c.item_name}</span>
