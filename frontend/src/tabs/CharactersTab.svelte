          ...
          {:else if detailTab === "quests"}
            <div class="detail quests-pane">
              ...
              {:else if questsData}
                ...
                {#if questsData.medallions.length}
                  <div class="q-section">Veeshan's Peak Medallion Pieces</div>
                  <div class="q-medgrid">
                    {#each questsData.medallions as m (m.item_id)}
                      <div class="q-med" class:held={m.held}>
                        <div class="q-medname">
                          {m.rune.replace("Medallion of the ", "")} — {m.piece}
                        </div>
                        {#if m.held}
                  ...
                  <div class="q-mednote">
                    Turn-ins: {[
                      ...new Set(questsData.medallions.map((m) => m.turn_in)),
                    ].join(" · ")}
                  </div>
                {/if}
