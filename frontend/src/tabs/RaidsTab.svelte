...
<div class="timers">
  ...
  {:else if srv && !srv.home}
    <div class="empty">
      <div class="big">Fuse raids paused on {srv.name}</div>
      <div class="hint">
        Raids, batphones and the timer board are P99 Blue features. You're on
        {srv.name}, so they're paused here — your triggers, overlays and Fuse
        package still work. Log in on Blue to see raid tracking again.
      </div>
    </div>
  {:else if loading}
