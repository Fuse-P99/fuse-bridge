        ...
        {#each inWindow as m}
          <div class="mob">
            <div class="mob-head">
              ...
              <span
                class="hov-wrap"
                class:show={isYou(m) || pendingStartOn(m)}
              >
                <span
                  class="hov-trigger"
                  class:on={isYou(m) || pendingStartOn(m)}
                >
                  {#if isYou(m)}{myRole(m)} ✓{:else if pendingStartOn(m)}{pending.role}
                    …{:else}+ sign up{/if}
                </span>
                <div class="hov-menu">
                  <div class="hm-body">
