  ...
  <div class="bar">
    ...
    <div class="char-row">
      ...
      <div class="char-dd">
        ...
        >
          {#if selChar}
            {#if selChar.server === "p1999green"}<span class="srv-dot green"
          ...
          <div class="char-panel">
            ...
            <div class="char-list">
              {#each filteredChars as c (c.key)}
                ...
                >
                  {#if c.server === "p1999green"}<span class="srv-dot green"
...
<style>
  ...
  /* World markers: which server a character's log belongs to (Blue carries
     none). Same green/red the P99 community uses for the servers; the test
     server gets a small gold T. */
  .srv-dot {
    width: 7px;
    height: 7px;
    border-radius: 50%;
