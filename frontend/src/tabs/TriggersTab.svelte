<script>
  ...
  const SPECIAL_OVERLAYS = [
    ...
    },
    {
      kind: "threat",
      name: "Threat Meter",
      desc: "DPS overlay, expands to include a threat meter during raids.",
      officer: true,
    },
    {
      kind: "raiddps",
      name: "Raid DPS",
      desc: "Live raid-wide damage on the current mob: total DPS, top 5, and a breakdown by class. Officer-only.",
      officer: true,
    },
  ];
