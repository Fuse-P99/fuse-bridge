          ...
          {#if !catClosed[c.name]}
            <div transition:slide|local={{ duration: 150 }}>
              {#each c.timers as t (t.id)}
                <div class="tbar" class:has-keep={t.keep}>
                  ...
                  {#if t.keep}
                    <span
                      class="tbar-keep"
                      title="Keeps running across all characters"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        width="11"
                      ...
                      >
                        <path
                          d="M18.5 12a3.5 3.5 0 0 1-3.5 3.5c-2 0-3-1.5-3-3.5s-1-3.5-3-3.5A3.5 3.5 0 1 0 6 15"
                        />
                      </svg>
                    </span>
                  {/if}
...
<style>
  ...
  /* Carry ("keeps running across characters") timers get a leading badge; the
     name shifts right to make room. */
  .tbar-keep {
    position: absolute;
    left: 7px;
    top: 50%;
