<script>
  ...
  // value may be a boolean (sliders), a string (choice) or a number (range).
            ...
            {:else if o.type === "num"}
              <label class="sw-row" title={o.title}>
                ...
                <input
                  ...
                  step="1"
                  value={+o.val || o.def}
                  on:input={(e) => setSpecialOpt(o.key, +e.target.value)}
                />
                <span class="opt-val">{+o.val || o.def}{o.unit || ""}</span>
              </label>
            {:else if o.type === "dec"}
