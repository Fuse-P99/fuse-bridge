  ...
  const SP_OPTS = {
    ...
    raidclerics: [
      ...
      },
      {
        ...
        type: "text",
        title:
          "Trigger sound file for the count pulse (a file name from your trigger sounds, e.g. intuition-561).",
        def: "intuition-561",
      },
    ],
    voicespeakers: [
      ...
      {#if spForm.opts && spForm.opts.length}
        <div class="opt-box">
          {#each spForm.opts as o (o.key)}
            ...
            {:else if o.type === "text"}
              <!-- free-text entry (e.g. a sound file name); saved on change -->
              <label class="sw-row" title={o.title}>
                <span class="opt-lbl">{o.label}</span>
                <input
                  class="opt-text"
                  ...
                  on:change={(e) =>
                    setSpecialOpt(o.key, e.target.value.trim() || o.def)}
                />
              </label>
            {:else}
              <label class="sw-row" title={o.title}>
