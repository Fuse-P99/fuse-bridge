    ...
    <div class="modal form">
      ...
      {:else}
        <div class="f-grid">
          ...
          <label class="f-chk">
            <input type="checkbox" bind:checked={catForm.style.alert_stopwatch} />
            Show how long each alert has been up (m:ss)
          </label>
        </div>
        <div class="f-note">
          A long Time Shown turns this overlay into a to-do list: an alert
          stays until its time runs out or one of its trigger's End Early
          conditions matches — a cleared alert flashes three times and
          disappears.
        </div>
      {/if}
      ...
      {:else if mainTab === "customize" && ovForm}
        ...
        <div class="ovr-box">
          ...
          {#if form.timer_enabled && form.ending_enabled}
            ...
            >
              <label class="f-label" for="tf-ovendsecs">Seconds before end</label
              >
              <input
                id="tf-ovendsecs"
                class="in num"
