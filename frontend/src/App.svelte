<script>
  ...
  const allTabs = [
    ...
    // Open to everyone: the walkthroughs are the point, and reading one costs
    // nothing. Editing is a separate matter — the editor's controls are
    // officer-only in the UI and the server enforces it on every write.
