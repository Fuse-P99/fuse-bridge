<script>
  ...
  const allTabs = [
    ...
    // Gated until the Timers launch (drop `gated` together with
    // triggersOfficerOnly in triggers_engine.go). View-as previews are the
    // exception — see the tabs filter below.
