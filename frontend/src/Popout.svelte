<script>
  ...
  // Racing speed-mode base offsets (percent of viewport width): the strafe
  // lines sit at different positions per movement speed. The user's manual
  // Line offset is fine calibration added on top (see the PopoutRacing prop).
  const RACING_SPEED_OFF = { run: 14, sow: 0.4, bard: -10 };
