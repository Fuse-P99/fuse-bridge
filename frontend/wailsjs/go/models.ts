export namespace main {
	...
	export class AutomationSettings {
	    ...
	    swap_bot: boolean;
	    main_toon: string;
	    rostered_toons: string[];
	
	    static createFrom(source: any = {}) {
	        return new AutomationSettings(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.add_tracking = source["add_tracking"];
	        this.swap_bot = source["swap_bot"];
	        this.main_toon = source["main_toon"];
	        this.rostered_toons = source["rostered_toons"];
	    }
	}
	...
	export class GameClockInfo {
	    have_game: boolean;
	    anchor_earth_ms: number;
	    anchor_game_hour: number;
	    ms_per_game_hour: number;
	    source: string;
	
	    static createFrom(source: any = {}) {
	        return new GameClockInfo(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.have_game = source["have_game"];
	        this.anchor_earth_ms = source["anchor_earth_ms"];
	        this.anchor_game_hour = source["anchor_game_hour"];
	        this.ms_per_game_hour = source["ms_per_game_hour"];
	...
	export class Settings {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.game_time = source["game_time"];
	...
	export class TriggerActivityUI {
	    at_ms: number;
	    path: string[];
	    trigger_id: number;
	
	    static createFrom(source: any = {}) {
	        return new TriggerActivityUI(source);
	    }
	...
	export class TriggerAlertUI {
	    text: string;
	    at_ms: number;
	
	    static createFrom(source: any = {}) {
	        return new TriggerAlertUI(source);
	    }
	...
	export class TriggerEditUI {
	    ...
	    restart_based_on_timer_name: boolean;
	    timer_start_behavior: string;
	    use_timer_ended: boolean;
	    timer_ended_text: string;
	    category: string;
	    unsupported: boolean;
	    enabled: boolean;
	
	    static createFrom(source: any = {}) {
	        return new TriggerEditUI(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.enable_regex = source["enable_regex"];
	        this.use_text = source["use_text"];
	        this.display_text = source["display_text"];
	        this.timer_enabled = source["timer_enabled"];
	        this.timer_name = source["timer_name"];
	        this.timer_seconds = source["timer_seconds"];
	        this.restart_based_on_timer_name = source["restart_based_on_timer_name"];
	        this.timer_start_behavior = source["timer_start_behavior"];
	        this.use_timer_ended = source["use_timer_ended"];
	        this.timer_ended_text = source["timer_ended_text"];
	        this.category = source["category"];
	        this.unsupported = source["unsupported"];
	        this.enabled = source["enabled"];
	    }
	}
	export class TriggerGroupUI {
	    id: number;
	    name: string;
	    enabled: boolean;
	    groups: TriggerGroupUI[];
	    triggers: TriggerEditUI[];
	
	    static createFrom(source: any = {}) {
	        return new TriggerGroupUI(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.name = source["name"];
	        this.enabled = source["enabled"];
	        this.groups = this.convertValues(source["groups"], TriggerGroupUI);
	        this.triggers = this.convertValues(source["triggers"], TriggerEditUI);
	    }
	...
	export class TriggerTimerUI {
	    ...
	    static createFrom(source: any = {}) {
	        return new TriggerTimerUI(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.ends_at_ms = source["ends_at_ms"];
	        this.trigger_id = source["trigger_id"];
	    }
	}
	export class TriggerStateUI {
	    imported: boolean;
	    character: string;
	    alert?: TriggerAlertUI;
	    timers: TriggerTimerUI[];
	    activity: TriggerActivityUI[];
	
	    static createFrom(source: any = {}) {
	        return new TriggerStateUI(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.alert = this.convertValues(source["alert"], TriggerAlertUI);
	        this.timers = this.convertValues(source["timers"], TriggerTimerUI);
	        this.activity = this.convertValues(source["activity"], TriggerActivityUI);
	    }
