...
// GetVoiceSpeaker returns who is currently speaking in the raid-voice channel
// (one person), for the Raids tab speaker indicator. Polled quickly.
func (a *App) GetVoiceSpeaker() VoiceSpeaker {
	return fetchVoiceSpeaker()
}
