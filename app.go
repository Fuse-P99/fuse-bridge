...
// is the home (P99 Blue) world. Off-home the UI shows a reduced-mode note and
// pauses the Blue-only guild/raid sections, matching the client's serverless
// behavior there (nothing is sent to the server; the Fuse package still loads).
