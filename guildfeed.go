...
// line whose Text is the whole line and whose Toon is the engaged player, or one
// of the world messages the server also relays to #guild-stream ("gm", "server",
// "quake"). Those last three have no speaker — an empty Toon is their correct
