...
// item: step outputs, reward items, and medallion pieces — retaining name,
// game item id, and bag location so the UI can say where things live.
...
// the threat meter's haste scan) and rescans when it changes.
