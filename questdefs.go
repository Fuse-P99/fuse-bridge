...
func qdRebuildLocked() {
	...
	for qi := range qdQuests {
		...
		if q.Class != "" && qdEpicRE.MatchString(q.Name) {
...
var vpMedallions = []vpMedallion{
	{19961, "Medallion of the Jarsath", "Upper", "Ground spawn (tiny bag near the waterline by a tree, 8h respawn)", "Swamp of No Hope", 52, 2935, true, "Xiblin Fizzlebik (Timorous Deep)"},
	{19960, "Medallion of the Jarsath", "Middle", "Drops from an ancient Jarsath (wanders after spawning — Sense the Dead helps)", "Firiona Vie", 0, 0, false, "Xiblin Fizzlebik (Timorous Deep)"},
	{19959, "Medallion of the Jarsath", "Bottom", "Drops from a bloodgill marauder (underwater in front of the temple, 8h respawn)", "Lake of Ill Omen", -378, -57, true, "Xiblin Fizzlebik (Timorous Deep)"},
	{19958, "Medallion of the Obulus", "Upper", "Burnished Wooden Staff quest from Ssolet Dnaas", "Warsliks Wood", 4014, 402, true, "Slixin Klex (Burning Woods)"},
	{19957, "Medallion of the Obulus", "Middle", "Drops from the rotting skeleton", "Dreadlands", 2252, -5144, true, "Slixin Klex (Burning Woods)"},
	{19956, "Medallion of the Obulus", "Bottom", "Drops from the Pained Soul (near the ramp to the Old Sebilis orb)", "Trakanon's Teeth", -1834, -4368, true, "Slixin Klex (Burning Woods)"},
	{19964, "Medallion of the Kylong", "Upper", "Niblek's Gems quest from Niblek", "Chardok", 506, -107, true, "Professor Akabao (Lake of Ill Omen)"},
	{19963, "Medallion of the Kylong", "Middle", "Drops from Verix Kyloxs Remains (basement)", "Karnor's Castle", 114, -631, true, "Professor Akabao (Lake of Ill Omen)"},
	{19962, "Medallion of the Kylong", "Bottom", "Ground spawn (2nd floor of the library, 8h respawn)", "Kaesora", 55, -439, true, "Professor Akabao (Lake of Ill Omen)"},
}
